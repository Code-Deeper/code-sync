                                ...
                                <div>
                                    <div className="flex -mx-3">
                                        <div className="w-1/2 px-3 mb-2">
                                            <label for="" className="font-bold font-semibold px-1">First name</label>
                                            <div className="flex">
                                        ...
                                        <div className="w-1/2 px-3 mb-2">
                                            <label for="" className="font-bold font-semibold px-1">Last name</label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                                <input
                                                    name="lastname"
                                    ...
                                    <div className="flex -mx-3">
                                        ...
                                        <div className="w-full px-3 mb-12">
                                            <label for="" className=" font-semibold px-1 font-bold">Confirm Password</label>
                                            <div className="flex">
                                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                                <input
                                                    name="confirmpassword"
                                    ...
                                    <div className="flex -mx-5">
                                        <div className="w-full px-3 mb-5">
                                            <button type="button" className="block w-full max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-indigo-700 text-gray-100 rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
