                                ...
                                <div>
                                    <div className="flex -mx-3">
                                        <div className="w-full px-3 mb-2 ml-3 mr-3">
                                            <label for="" className="font-bold font-semibold px-1">Email</label>
                                    ...
                                    <div className="flex -mx-3 mt-4">
                                        <div className="w-full px-3  ml-3 mr-3">
                                            <label for="" className=" font-semibold px-1 font-bold">Password</label>
                                            <div className="flex mt-2">
                                            ...
                                            <GoogleLogin
                                                ...
                                                render={
                                                    (renderProps) => (
                                                        <>
                                                            <Button
                                                                className='google-btn block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-gray-100 rounded-lg px-3 py-3 font-semibold'
                                                                color="primary"
                                                                fullWidth
