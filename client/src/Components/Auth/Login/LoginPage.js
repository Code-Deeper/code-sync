                    ...
                    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: "1000px" }} >
                        <div class="md:flex w-full">
                            ...
                            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                                ...
                                <div>
                                    <div class="flex -mx-3">
                                        <div class="w-full px-3 mb-2 ml-3 mr-3">
                                            <label for="" class="font-bold font-semibold px-1">Email</label>
                                            <div class="flex mt-2">
                                    ...
                                    <div class="flex -mx-3 mt-4">
                                        <div class="w-full px-3  ml-3 mr-3">
                                            <label for="" class=" font-semibold px-1 font-bold">Password</label>
                                            <div class="flex mt-2">
                                    ...
                                    <div class="flex-col -mx-5 mt-10">
                                        <div class="w-full px-3 mb-5">
                                            <button
                                                type="submit"
                                                class="block w-full max-w-sm mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-gray-100 rounded-lg px-3 py-3 font-semibold"
                                    ...
                                    <div className='right-0	mt-3 ml-6 mb-6'>
