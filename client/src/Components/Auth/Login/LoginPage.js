                            ...
                            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                                ...
                                <div>
                                    ...
                                    <div class="flex -mx-3 mt-4">
                                        <div class="w-full px-3 mb-12 ml-3 mr-3">
                                    ...
                                    <div class="flex-col -mx-5">
                                        <div class="w-full px-3 mb-5">
                                            <button
                                                type="submit"
                                                class="block w-full max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-indigo-700 text-gray-100 rounded-lg px-3 py-3 font-semibold"
