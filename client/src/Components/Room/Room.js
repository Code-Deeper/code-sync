              ...
              <div className="ide-container">
                <div className="center ide-low">
                  <div className="ide-header">
                    <h5 className="flex"><svg width="27" height="23" viewBox="0 0 27 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className=" text-center ip-op-editor grid grid-flow-row grid-cols-2 m0">
                    ...
                    <div className="ip-op-container">
                      <div className="header-ip-op">
                        <h5 className="Input flex">Input <svg  width="22" height="22" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="ip-op-container">
                        ...
                        {console.log(output)}
                        <div className="header-ip-op">
                        <h5 className="Output flex">Output<svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
