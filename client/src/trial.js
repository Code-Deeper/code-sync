...
// Singin Page
    ...
    //                             <label for="" class="font-bold font-semibold px-1">First name</label>
    //                             <div class="flex">
    ...
    //                         </div>
    //                         <div class="w-1/2 px-3 mb-2">
    //                             <label for="" class="font-bold font-semibold px-1">Last name</label>
    //                             <div class="flex">
    //                                 <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
    ...
    //                             <button type="button" class="block w-full max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
    //                         </div>
    //                     </div>
    //                 </div>
    //             </div>
